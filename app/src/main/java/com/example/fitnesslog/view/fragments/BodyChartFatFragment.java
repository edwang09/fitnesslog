...
import com.example.fitnesslog.databinding.FragmentBodyChartFatBinding;
...
public class BodyChartFatFragment extends Fragment {
    private FragmentBodyChartFatBinding mBinding;
    private RoutineViewModel mRoutineViewModel;
    @Override
    public View onCreateView(LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        mBinding = FragmentBodyChartFatBinding.inflate(inflater, container, false);
